...
insert into "posts" ( "topicID", "userID", "html", "markdown", "dateCreated", "draft", "editorID", "lastModified", "lockedByID" )
  select distinct "intConversationID" + 20000 as "topicID", "intSenderUserID" as "userID", "vchMessageText" as "html", "vchMessageText" as "markdown", "dteTimeSent" as "dateCreated", false as "draft", "intSenderUserID" as "editorID", "dteTimeSent" as "lastModified", 0 as "lockedByID" from "tblForumPrivateMessages"
