...
CREATE TABLE user_groups (
    ...
    content_restrictions boolean NOT NULL,
...
CREATE UNIQUE INDEX user_activation_pkey ON user_activation(user_id int4_ops);
...
INSERT INTO "user_groups" ("id","name","url","description","login","post","reply","content_restrictions","talk_privately","moderate_discussions","administrate_discussions","moderate_users","administrate_users","administrate_app","bypass_lockdown","system","locked")
VALUES
(1, 'Public','Public','Public (anonymous) visitors.',FALSE,FALSE,FALSE,TRUE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,TRUE,FALSE),
(2, 'Pending Activation','Pending-Activation','Forum members awaiting account activation.',FALSE,FALSE,FALSE,TRUE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,TRUE,TRUE),
(3, 'New Members','New-Members','Forum members who can reply to existing topics, but haven''t met the minimum post requirement to start new topics.',TRUE,TRUE,TRUE,TRUE,TRUE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,TRUE,FALSE),
(4, 'Members','Members','Forum members with full access to post and reply.',TRUE,TRUE,TRUE,FALSE,TRUE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,TRUE,FALSE),
(5, 'Moderators','Moderators','Members responsible for moderating users and content.',TRUE,TRUE,TRUE,FALSE,TRUE,TRUE,FALSE,TRUE,FALSE,FALSE,TRUE,TRUE,FALSE),
(6, 'Administrators','Administrators','Members with full control over the forum, including access to the admin. This group''s permissions are locked in order to prevent accidental removal of administration capabilities.',TRUE,TRUE,TRUE,FALSE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE,TRUE),
(7, 'Banned Members','Banned-Members','Users who have had their forum access privileges revoked.',FALSE,FALSE,FALSE,TRUE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,FALSE,TRUE,FALSE);
...
VALUES
(6,'Administrator','$2a$10$OcEsQ1L2jizBqw1CPmLG6uK6ZJuUB39TDYOBH9RLXmKD44mvm3sCa','$2a$12$BUs.SDPtAxSkSAjJGf6G2eb348JbZPVR0OmnXySJs2M5IDDh0Wf62','Administrator','admin@comitium.com','GMT','MMMM D, YYYY','Comitium Light',NULL,NULL,now(),now(),NULL,TRUE,TRUE,TRUE,'N/A',TRUE,TRUE);
